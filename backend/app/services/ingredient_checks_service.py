...
class IngredientChecksService:
    def __init__(self, repository: CompositeRepository, gemini_client: GeminiClient) -> None:
        self.repository = repository
        self.gemini_client = gemini_client

    async def analyze_text(self, clerk_user_id: str, ingredients_text: str) -> IngredientCheckResponse:
    ...
    async def analyze_image(self, clerk_user_id: str, image_bytes: bytes, mime_type: str) -> IngredientCheckResponse:
